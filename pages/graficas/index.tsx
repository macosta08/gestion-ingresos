...
import { Grafica } from "@/components/AtomicDesign/Molecules/Grafica"
 ...
 function Graficas() {
  ...
  return (
        ...
        <Grafica titulo='Usuarios' data={dataUsuarios} argument='motivo' value="cantidad"/>
        <Grafica titulo='Ingresos y egresos' data={dataIngresosEgresos} argument='motivo' value="cantidad"/></div>
        </div>
  )
}
