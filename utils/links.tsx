...
export const links: LinkItem[] = [
    ...
    { name: 'Graficas', link: '/graficas', icon: <Package2 className="h-5 w-5" /> }
  ]
  ...
  export const linksCards: LinkItemCard[] = [
    ...
    { name: 'Graficas', link: '/graficas', description: 'Introducing Our Dynamic Orders Dashboard for Seamless Management and Insightful Analysis.', icon: <Package2 className="h-5 w-5" /> }
  ]